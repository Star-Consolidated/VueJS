				...
				<template v-slot:top>
					<v-toolbar flat color="white">
									...
									<v-container>
										<v-row>		
											<v-col cols="12" sm="6" md="4">
												<v-text-field v-model="editedItem.productoID" label="Producto Id" readonly></v-text-field>
											</v-col>									
											<v-col cols="12" sm="6" md="4">
						...
						<v-dialog v-model="dialogConfirm" max-width="290">
							<v-card>
								<v-card-title class="headline">Delete Producto?</v-card-title>
								<v-card-text>
									Would you like to delete this producto?
